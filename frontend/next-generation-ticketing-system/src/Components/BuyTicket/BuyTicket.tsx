    ...
    return (
        <div className="border-2 border-white p-6 rounded-2xl bg-black bg-opacity-75">
          <div className="flex justify-between pb-2">
            <img src={require("./../../Pictures/Icons/exit-alt-white.png")} alt="steering wheel icon" width={64}/>
            <img src={require("./../../Pictures/Icons/steering-wheel-white.png")} alt="steering wheel icon" width={64}/>
          </div>
          <div>
                  ...
                  {Array.from({ length: 4 }).map((_, rowIndex) => {
                    ...
                    if (seat !== undefined && seat!==null) {
                      return (
                          <button
                              key={seat.seatId}
                              className={`${rowIndex ===2 && "ms-10"} ${seatSelected.some(st => st === seat) && "bg-blue-950 bg-opacity-75 border-green-700 hover:bg-blue-700 hover:bg-opacity-75"} bg-blue-400 bg-opacity-75 border border-1 border-blue-200 rounded ${seat.ticket && "pointer-events-none bg-gray-500 bg-opacity-75 border-red-500"} hover:bg-blue-700 text-white font-bold py-2 px-4 m-1 w-16`}
